...
user_1 = User('John', 'Doe', 'Ibiza')
user_repository.save(user_1)
user_2 = User('Bruce', 'Dickinson', 'Brazil')
user_repository.save(user_2)
user_3 = User('Alan', 'Watts', 'California')
user_repository.save(user_3)

country_1 = Country("Brazil")
country_repository.save(country_1)
country_2 = Country("Cuba")
country_repository.save(country_2)
country_3 = Country("China")
country_repository.save(country_3)
country_4= Country("Denmark")
country_repository.save(country_4)
country_5 = Country("France")
country_repository.save(country_5)
country_6 = Country("Greece")
country_repository.save(country_6)
country_7 = Country("Italy")
country_repository.save(country_7)
country_8 = Country("Saudi Arabia")
country_repository.save(country_8)
country_9 = Country("Ukraine")
country_repository.save(country_9)
country_10 = Country("Vietnam")
country_repository.save(country_10)

city_1 = City(country_1, 'Rio de Janeiro')
city_repository.save(city_1)
city_2 = City(country_1, 'Sao Paulo')
city_repository.save(city_2)
city_3 = City(country_1, 'Salvador')
city_repository.save(city_3)
city_4 = City(country_2, 'Havana')
city_repository.save(city_4)
city_5 = City(country_2, 'Santa Clara')
city_repository.save(city_5)
city_6 = City(country_2, 'Cienfuegos')
city_repository.save(city_6)
city_7 = City(country_3, 'Beijing')
city_repository.save(city_7)
city_8 = City(country_3, 'Shanghai')
city_repository.save(city_8)
city_9 = City(country_3, 'Shenzhen')
city_repository.save(city_9)
city_10 = City(country_4, 'Copenhagen')
city_repository.save(city_10)
city_11 = City(country_4, 'Odense')
city_repository.save(city_11)
city_12 = City(country_4, 'Aalborg')
city_repository.save(city_12)
city_13 = City(country_5, 'Paris')
city_repository.save(city_13)
city_14 = City(country_5, 'Marseille')
city_repository.save(city_14)
city_15 = City(country_5, 'Lyon')
city_repository.save(city_15)
city_16 = City(country_6, 'Athens')
city_repository.save(city_16)
city_17 = City(country_6, 'Thessaloniki')
city_repository.save(city_17)
city_18 = City(country_6, 'Kalamata')
city_repository.save(city_18)
city_19 = City(country_7, 'Rome')
city_repository.save(city_19)
city_20 = City(country_7, 'Venice')
city_repository.save(city_20)
city_21 = City(country_7, 'Milan')
city_repository.save(city_21)
city_22 = City(country_8, 'Riyadh')
city_repository.save(city_22)
city_23 = City(country_8, 'Jeddah')
city_repository.save(city_23)
city_24 = City(country_8, 'Medina')
city_repository.save(city_24)
city_25 = City(country_9, 'Kyiv')
city_repository.save(city_25)
city_26 = City(country_9, 'Odesa')
city_repository.save(city_26)
city_27 = City(country_9, 'Kharkiv')
city_repository.save(city_27)
city_28 = City(country_10, 'Ho Chi Minh')
city_repository.save(city_28)
city_29 = City(country_10, 'Hanoi')
city_repository.save(city_29)
city_30 = City(country_10, 'Nha Trang')
city_repository.save(city_30)
